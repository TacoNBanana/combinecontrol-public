...
DONATION_CHAR_STATENDURANCE			= 4
DONATION_CHAR_STATAGILITY			= 5
DONATION_CHAR_STATDEXTERITY			= 6
DONATION_CHAR_STATS					= 7
DONATION_CHAR_MODEL					= 8
...
--tekka needs seperate fields for hair, headgear, masks.....also 3 slots for augmentation combinations
--needs to be updated hair for sv_compoundmodel also
EQUIPMENT_HEAD 		= 1
EQUIPMENT_MASK 		= 2 --is this already set up for tekka?
EQUIPMENT_CHEST 	= 3
EQUIPMENT_EXO 		= 4
EQUIPMENT_PRIMARY 	= 5
EQUIPMENT_SECONDARY = 6
EQUIPMENT_EQUIP1 	= 7 -- these can be replaced, not used
EQUIPMENT_EQUIP2 	= 8 -- these can be replaced, not used
EQUIPMENT_ID 		= 9 --old combine feature, could be re-used for tekka
EQUIPMENT_RADIO 	= 10
EQUIPMENT_LIGHT		= 11
--EQUIPMENT_AUG1		= 12
--EQUIPMENT_AUG2		=
...
EQUIPMENT_TO_TEXT 						= {}
EQUIPMENT_TO_TEXT[EQUIPMENT_HEAD] 		= "Headgear"
EQUIPMENT_TO_TEXT[EQUIPMENT_MASK] 		= "Mask"
EQUIPMENT_TO_TEXT[EQUIPMENT_CHEST] 		= "Uniform"
EQUIPMENT_TO_TEXT[EQUIPMENT_EXO] 		= "Exosuit"
EQUIPMENT_TO_TEXT[EQUIPMENT_PRIMARY] 	= "Primary"
EQUIPMENT_TO_TEXT[EQUIPMENT_SECONDARY] 	= "Secondary"
EQUIPMENT_TO_TEXT[EQUIPMENT_EQUIP1] 	= "Equipment 1"
EQUIPMENT_TO_TEXT[EQUIPMENT_EQUIP2] 	= "Equipment 2"
EQUIPMENT_TO_TEXT[EQUIPMENT_ID] 		= "ID Card"
EQUIPMENT_TO_TEXT[EQUIPMENT_RADIO] 		= "Radio"
EQUIPMENT_TO_TEXT[EQUIPMENT_LIGHT]		= "Light"
--EQUIPMENT_TO_TEXT[EQUIPMENT_AUG1]		= "Augment Slot 1"
