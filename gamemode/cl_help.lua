function GM:RefreshHelpMenuContent()
	self.HelpContent = {
		...
		I - Infiltrator
		J - T-200
		K - T-600 (Skinjob w/ M203)
		L - SkyNet Slave
		M - T-450
		O - T-70 Widow
		P - T-20
		R - T-500 Reaver
		r - T-500 Reaver (Reprog)
		S - SkyNet
	...
	if LocalPlayer():IsAdmin() then
		...
		rpa_setstats - Set all of a player's stats.

		rpa_playernotes [player] - Open a list of the player's admin notes.

		rpa_mute [player] - Mutes or unmutes a player from OOC.
		rpa_travelban [player] - Prevents a player from using transfer points.

		rpa_settrait [player] [trait] - Set a player's trait.
		...
		rpa_givelicense [player] [license] - Give a player a business license.
		rpa_takelicense [player] [license] - Take a business license from a player.

		Available licenses:
		generic    clothing      medical
		weaponry    illegal       quartermaster
