function GM:GetHL2CamPos()
	...
	return {Vector(5677, 2435, 1332), Angle(2.6, -70.9, 0.0)}
end
...
--	self:CreateLocationPoint(Vector(11466, -7884, -13476), LOCATION_CANAL, 256, TRANSITPORT_CITY_SEWER) --canals entrance changed to vort cave to save run time
	self:CreateLocationPoint(Vector(-15132, 12746, 70), LOCATION_CITY, 256, TRANSITPORT_CITY_GATE) --Caved in road tunnel	
	self:CreateLocationPoint(Vector( 14462, -14687, 80), LOCATION_CITY, 256, TRANSITPORT_CITY_COMBINE) --Combine Base door
--	self:CreateLocationPoint(Vector(11466, -7884, -13476), LOCATION_CAVES, 256, TRANSITPORT_CAVES_ENTRY) -- vort cave at NLO
...
GM.ConnectMessages[TRANSITPORT_CITY_GATE] = "This tunnel leads back to the city."
