...
GAMEMODE.LoadoutCrates = {
	{Vector(1297, 1111, 529), Angle()}
}
...
--this stuff stops the wierd sky and weather effects etc
...
function GM:MapInitPostEntity()
	self:CreateLocationPoint(Vector(-4079, 3951, 690), LOCATION_CANAL, 128, TRANSITPORT_CITY_GATE)
	self:CreateLocationPoint(Vector(1296, 426.5, 1504), LOCATION_CANAL, 128, TRANSITPORT_CITY_COMBINE)
end

GM.ConnectMessages[TRANSITPORT_CITY_GATE] = "This traincar door appears to be loose, with enough force you might be able to squeeze through."
GM.ConnectMessages[TRANSITPORT_CITY_COMBINE] = "This Helicopter at this helipad is prepared and ready to Air-Lift you to Sector 12"
 
GM.EntryPortSpawns[TRANSITPORT_CITY_GATE] = {
	Vector(-2993, 4174, 700),
	Vector(-2877, 4170, 700),
	Vector(-2828, 4098, 700),
}
...
GM.EntryPortSpawns[TRANSITPORT_CITY_COMBINE] = {
	Vector(1299.746948, 388.381592, 1504.03125),
	Vector(1348.613770, 551.750183, 1504.031250),
	Vector(1440.013794, 667.590332, 1504.031250),
	Vector(1363.264771, 315.193665, 1504.031250),
}
...
GM.DoorData = {
	...
	{Vector(988, -3991, 718.28100585938), 1, "Store", 5, "REST"},
	{Vector(824, -3524, 728), 1, "Store", 5, "REST"},
	{Vector(743, -3725, 718.28100585938), 0, "Back", 0, "REST"},

	{Vector(471, -3836, 746.28100585938), 1, "Warehouse", 5},

	{Vector(-560.04498291016, -1476.0100097656, 726), 1, "FOTO Shop", 5, "FOTO"},
	{Vector(-791, -1145, 726.28100585938), 0, "Backroom", 0, "FOTO"},

	{Vector(686.28100585938, -1220.0899658203, 766.28100585938), 1, "CHANGE Shop", 5, "CHANGE"},
	{Vector(594.28100585938, -1220.0899658203, 766.28100585938), 1, "CHANGE Shop", 5, "CHANGE"},
	{Vector(988.27398681641, -1495.9499511719, 766), 0, "Backroom", 0, "CHANGE"},

	{Vector(1156.0899658203, 207.28100585938, 782.28100585938), 1, "Warehouse", 5, "WARE1"},
	{Vector(1156.0899658203, 115.28099822998, 782.28100585938), 1, "Warehouse", 5, "WARE1"},
	...
	{Vector(-1724, -455, 878.28100585938), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-1-1", 2, "A11"},
	{Vector(-1610, -143, 878.28100585938), 0, "Toilet", 0, "A11"},
	{Vector(-1723, 33, 878.28100585938), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-1-2", 2, "A12"},
	{Vector(-1610, 289.29998779297, 878.28100585938), 0, "Toilet", 0, "A12"},
	{Vector(-1724, -455.3030090332, 1007.2800292969), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-2-1", 2, "A21"},
	{Vector(-1610, -143, 1007.2800292969), 0, "Toilet", 0, "A21"},
	{Vector(-1723, 32.697200775146, 1007.2800292969), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-2-2", 2, "A22"},
	{Vector(-1610, 289.2919921875, 1007.2800292969), 0, "Toilet", 0, "A22"},
	{Vector(-1724, -455, 1134.2800292969), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-3-1", 2, "A31"},
	{Vector(-1610, -142.69700622559, 1134.2800292969), 0, "Toilet", 0, "A31"},
	{Vector(-1723, 33.000099182129, 1134.2800292969), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-3-2", 2, "A32"},
	{Vector(-1610, 289.29998779297, 1134.2800292969), 0, "Toilet", 0, "A32"},
	{Vector(-1724, -454, 1262.2800292969), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-4-1", 2, "A41"},
	{Vector(-1610, -141.69700622559, 1262.2800292969), 0, "Toilet", 0, "A41"},
	{Vector(-1723, 34.000099182129, 1262.2800292969), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-4-2", 2, "A42"},
	{Vector(-1610, 289.24700927734, 1262.2800292969), 0, "Toilet", 0, "A42"},
	{Vector(-1724, -455, 1390.2800292969), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-5-1", 2, "A51"},
	{Vector(-1610, -142.69700622559, 1390.2800292969), 0, "Toilet", 0, "A51"},
	{Vector(-1723, 33.000099182129, 1390.2800292969), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-5-2", 2, "A52"},
	{Vector(-1610, 289.29998779297, 1390.2800292969), 0, "Toilet", 0, "A52"},

	{Vector(-2048, 922, 848), 2, "Ration Terminal"},

	{Vector(-66.090797424316, 130.26800537109, 782), 1, "Large Store", 5, "LARGE"},
	{Vector(-66, 222, 782), 1, "Large Store", 5, "LARGE"},
	{Vector(-85.992599487305, 510.09100341797, 1286), 1, "Large Store", 5, "LARGE"},
	...
	{Vector(367, 1923, 1334.2800292969), 1, "Warehouse", 5, "WARE2"},
	{Vector(33, 1732, 1334.2800292969), 0, "", 0, "WARE2"},

	{Vector(105, 2895, 1278.2800292969), 1, "Apartments", 5},
	{Vector(-409, 2644, 1142.2800292969), 1, "Apartment B-1-1", 5, "B11"},
	{Vector(-351, 2644, 1142.2800292969), 1, "Apartment B-1-2", 5, "B12"},

	{Vector(867, 1860, 1438.2800292969), 1, "Apartment C-1-1", 2},
	{Vector(937, 1869, 1438.2800292969), 1, "Apartment C-1-2", 2},
	{Vector(1111, 1904, 1438.2800292969), 1, "Apartment C-1-3", 2},

	{Vector(1246.0899658203, 3040.7199707031, 1198), 1, "Fat Nargodian", 5, "FAT"},
	{Vector(1246.0899658203, 3134.7199707031, 1198.2800292969), 1, "Fat Nargodian", 5, "FAT"},
	...
	{Vector(-760, 3617, 930), 1, "Apartment D-1-1", 2},

	{Vector(-223, 3460, 934.28100585938), 1, "Souvenir Shop", 5, "SOUV"},
	{Vector(9, 3952, 922.28100585938), 0, "Toilet", 0, "SOUV"},

	{Vector(-999, 2953, 790.28100585938), 1, "Bar", 5, "BAR"},
	{Vector(-1617, 3133, 790.28100585938), 0, "Toilet", 0, "BAR"},
	{Vector(-1817, 3177, 790.28100585938), 0, "Storage", 0, "BAR"},

	{Vector(807, -1884, 1238.2800292969), 1, "Warehouse", 5, "WARE4"},
	...
	{Vector (1468, -899.98999023438, 1684), 2, "Administration"},
	{Vector (1784, -1448, 1684), 2, "Broadcasting"},
...
GM.CameraData = {
	{Vector(-2004.28, 961.875, 941.969), Angle(0, 77.6514, 0), "TERMINAL", true},
	{Vector(2186.72, -872.375, 677.969), Angle(0, 135.747, 0), "NEXUS-SIDE", true},
	{Vector(2922.63, 782.625, 1133.97), Angle(0, -49.5264, 0), "NEXUS-MAIN", true},
	{Vector(1960.97, 2219.41, 1469.97), Angle(0, -133.77, 0), "NEXUS-D2"},
	{Vector(423.125, 3365.81, 1405.97), Angle(0, -133.242, 0), "D2-APTS"},
	{Vector(2211.94, 449.031, 781.969), Angle(0, -174.946, 0), "DETAINMENT", true},
	{Vector(749.375, -1197.66, 909.969), Angle(0, 127.09, 0), "CHANGE", true}
}