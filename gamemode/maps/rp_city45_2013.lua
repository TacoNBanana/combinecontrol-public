...
function GM:GetCACamPos()
	return Vector(1979.692017, 589.656738, 2943.031250)
end

function GM:TurnOnCamera()
	ents.FindByName("nexus_broadcast_magicbutton3")[1]:Fire("use")
end

function GM:TurnOffCamera()
	ents.FindByName("nexus_broadcast_magicbutton")[1]:Fire("use")
end
...
if (SERVER) then
	...
	local function broinz()
		if not BreenExists then
			GAMEMODE:CreateBreen("nexus_broadcast_camera", GAMEMODE:GetCACamPos(), Angle(0, 90, 0.000000))
			BreenExists = true
		end
	end
...
GM.VendingMachines = {
	{Vector(-1434, 2969, 586), Angle(0, -90, 0)},
	{Vector(-1250, 2700, 586), Angle(0, 90, 0)},
	{Vector(-1014, 1439, 587), Angle(0, 180, 0)},
	{Vector(-1014, 1387, 587), Angle(0, 180, 0)},
	{Vector(1028, 1003, 548), Angle(0, -179, 0)},
	{Vector(1028, 1063, 548), Angle(0, 180, 0)},
	{Vector(-1722, 314, 550), Angle(0, -89, 0)},
	{Vector(1574, 2476, 548), Angle(0, -90, 0)},
	{Vector(2448, 2696, 668), Angle(0, 180, 0)},
	{Vector(2448, 2643, 668), Angle(0, 180, 0)},
	{Vector(9120, -411, 672), Angle(0, 91, 0)},
	{Vector(8702, -3094, 608), Angle(0, -0, 0)},
	{Vector(8702, -3041, 608), Angle(0, 0, 0)},
}
...
GM.DoorData = {
	...
	{Vector(962.24200439453, 3797, 553.00402832031), DOOR_BUYABLE, "DiORDNA", 5},
	{Vector(5596, 661, 542), DOOR_BUYABLE, "Warehouse", 5, "WAREHOUSE1"},
	{Vector(5668, 661, 542), DOOR_BUYABLE, "Warehouse", 5, "WAREHOUSE1"},
	{Vector(8629, -435, 677), DOOR_BUYABLE, "Room", 5},
	{Vector(8608.5, -1681, 570.5), DOOR_BUYABLE, "Generator Room", 5},
	{Vector(8944, -2741.5, 618.5), DOOR_UNBUYABLE, "Apartment Block B"},
	{Vector(9191, -2414, 549), DOOR_BUYABLE, "Shop", 5},
	{Vector(803.5, 928.5, 553), DOOR_BUYABLE, "Cafe Baltic", 5, "CAFE"},
	{Vector(419.5, 964.5, 553), DOOR_BUYABLE, "FOTO Shop", 5, "FOTO"},
	{Vector(-2064, 3006.0100097656, 587), DOOR_COMBINEOPEN, ""},
	{Vector(186.5, 1036.5, 553), DOOR_BUYABLE, "Souvenir Shop", 5, "SOUVENIR"},
	...
	{Vector(8869, -2965, 741), DOOR_BUYABLE_ASSIGNABLE, "Apartment B-1-1", 2},
	{Vector(9029, -2965, 741), DOOR_BUYABLE_ASSIGNABLE, "Apartment B-1-2", 2},
	{Vector(9029, -2965, 869), DOOR_BUYABLE_ASSIGNABLE, "Apartment B-2-2", 2},
	{Vector(8869, -2965, 869), DOOR_BUYABLE_ASSIGNABLE, "Apartment B-2-1", 2},
	{Vector(9029, -2965, 997), DOOR_BUYABLE_ASSIGNABLE, "Apartment B-3-2", 2},
	{Vector(8869, -2965, 997), DOOR_BUYABLE_ASSIGNABLE, "Apartment B-3-1", 2},
	{Vector(9043, -3125, 741), DOOR_BUYABLE_ASSIGNABLE, "Apartment B-1-3", 2},
	{Vector(9043, -3125, 869), DOOR_BUYABLE_ASSIGNABLE, "Apartment B-2-3", 2},
	{Vector(9043, -3125, 997), DOOR_BUYABLE_ASSIGNABLE, "Apartment B-3-3", 2},
	{Vector(2609, 2824, 674.33099365234), DOOR_UNBUYABLE, "", 0, "A12"},
	{Vector(3025, 2845, 674.28100585938), DOOR_UNBUYABLE, "", 0, "A11"},
	{Vector(2837, 2898, 673), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-1-1", 2, "A11"},
	{Vector(2717, 2898, 673), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-1-2", 2, "A12"},
	{Vector(2609, 2824, 831.33099365234), DOOR_UNBUYABLE, "", 0, "A22"},
	{Vector(2717, 2898, 830), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-2-2", 2, "A22"},
	{Vector(3025, 2845, 831.28100585938), DOOR_UNBUYABLE, "", 0, "A21"},
	{Vector(2837, 2898, 830), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-2-1", 2, "A21"},
	{Vector(3025, 2845, 988.28100585938), DOOR_UNBUYABLE, "", 0, "A31"},
	{Vector(2837, 2898, 987), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-3-1", 2, "A31"},
	{Vector(2609, 2824, 988.33099365234), DOOR_UNBUYABLE, "", 0, "A32"},
	{Vector(2717, 2898, 987), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-3-2", 2, "A32"},
	...
	{Vector(1911, 2898, 987), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-3-3", 2, "A33"},
	{Vector(2109, 2870, 988.33099365234), DOOR_UNBUYABLE, "", 0, "A33"},
	{Vector(1791, 2898, 987), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-3-4", 2, "A34"},
	{Vector(1691, 2799, 988.28100585938), DOOR_UNBUYABLE, "", 0, "A34"},
	{Vector(1791, 2898, 830), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-2-4", 2, "A24"},
	{Vector(1691, 2799, 831.28100585938), DOOR_UNBUYABLE, "", 0, "A24"},
	{Vector(1911, 2898, 830), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-2-3", 2, "A23"},
	{Vector(2109, 2870, 831.33099365234), DOOR_UNBUYABLE, "", 0, "A23"},
	{Vector(1911, 2898, 673), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-1-3", 2, "A13"},
	{Vector(1791, 2898, 673), DOOR_BUYABLE_ASSIGNABLE, "Apartment A-1-4", 2, "A14"},
	...
	{Vector(10706, 1707, 718.28100585938), DOOR_BUYABLE, "Warehouse", 5, "WAREHOUSE2"},
	{Vector(10180, 1560, 848.28100585938), DOOR_UNBUYABLE, "", 0, "WAREHOUSE2"},
	{Vector(11161, 1515, 718), DOOR_BUYABLE, "Waste Processing", 5, "WASTE"},
	{Vector(11582, 1922, 718), DOOR_BUYABLE, "Waste Processing", 5, "WASTE"},
	{Vector(12254, 1389, 718), DOOR_BUYABLE, "Building", 5, "BUILDING"},
	{Vector(11783, 1775, 718), DOOR_BUYABLE, "Building", 5, "BUILDING"},
	{Vector(11264, 195.94999694824, 718.28100585938), DOOR_BUYABLE, "Warehouse", 5, "WAREHOUSE3"},
	{Vector(11678, -45.049800872803, 718.28100585938), DOOR_BUYABLE, "Loft Warehouse", 2, "LOFT"},
	{Vector(11148, 695, 424.28100585938), DOOR_BUYABLE, "Canal Shack", 5},
	{Vector(10410.400390625, 14.719200134277, -28.718999862671), DOOR_BUYABLE, "Hidden Building", 2, "HIDDEN"},
	{Vector(10410.400390625, 107.71900177002, -28.718999862671), DOOR_BUYABLE, "Hidden Building", 2, "HIDDEN"},
	{Vector(10917, 65, 718.28100585938), DOOR_BUYABLE, "Warehouse", 5, "WAREHOUSE4"},
	...
	{Vector(-1796, 187, 681), DOOR_BUYABLE, "Large Shop", 2, "SHOP3"},
	{Vector(-1796, 281, 681), DOOR_BUYABLE, "Large Shop", 2, "SHOP3"},
	...
	{Vector(1685.5, 2638, 554.5), DOOR_BUYABLE, "Shop", 2, "SHOP1"},
	{Vector(2064.5, 2638, 554.5), DOOR_BUYABLE, "Shop", 2, "SHOP2"},
}

GM.CameraData = {
	{Vector(1122, 1173, 729), Angle(0, 90, 0), "NEXUS-01", true},
	{Vector(1577, 1626, 729), Angle(0, 180, 0), "NEXUS-02", true},
	{Vector(2222, 2481.88, 754), Angle(0, -45, 0), "CCH-A", true},
	{Vector(560.906, 3140.41, 712), Angle(0, 0, 0), "RDC", true}
}