...
GM.ConnectMessages[TRANSITPORT_CAVES_ENTRY] = "You've been here before. Outside, there's a few miles of wild forest leading into City 17's canal system."
...
GM.EntryPortSpawns[TRANSITPORT_COAST_ENTRY] = {
	Vector(-6952, 1665, -645),
	Vector(-6897, 1676, -651),
	Vector(-6819, 1687, -644),
	Vector(-6899, 1780, -651),	
}
