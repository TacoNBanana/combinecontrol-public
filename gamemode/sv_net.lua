...
util.AddNetworkString("nAPlayYT")
util.AddNetworkString("nAStopYT")
...
util.AddNetworkString("nCGiveMoney")
util.AddNetworkString("nCReceiveMoney")
...
util.AddNetworkString("nUseWeapon")
...
util.AddNetworkString("nVendingMachineNoMoney")
...
util.AddNetworkString("nACharacterLookup")
...
util.AddNetworkString("nSetItemUserDescription")

util.AddNetworkString("nADestroyItem")
util.AddNetworkString("nATakeItem")

util.AddNetworkString("nClosePlayerInventory")
