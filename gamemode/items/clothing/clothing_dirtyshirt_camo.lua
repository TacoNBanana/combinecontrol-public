...
ITEM.Name 					= "Scavenger Clothes (Camo fatigues)"
...
ITEM.ModelData 				= {}
ITEM.ModelData.model 		= Model("models/tnb/techcom/male_dirtyshirt.mdl")
ITEM.ModelData.skin 		= 1

ITEM.ModelDataFemale 		= {}
ITEM.ModelDataFemale.model 	= Model("models/tnb/techcom/female_dirtyshirt.mdl") 
