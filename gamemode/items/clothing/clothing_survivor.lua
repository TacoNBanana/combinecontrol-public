...
ITEM.Name 					= "Survivor Outfit"
ITEM.Description 			= "A tattered and dirty grey tracksuit."
...
if SERVER then
	function ITEM:GetModelData(ply, data)
		data.body = {
			model = string.format("models/tnb/clothing/trp/body/%s_survivor.mdl", ply:Gender()),
