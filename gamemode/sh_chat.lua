...
GM:AddMessageType({
	...
	OnReceived		= function(t)
		...
		if t.Custom.Stationary then
			freq = string.format("Stationary Radio - %s", freq)
		end
...
GM:AddMessageType({
	...
	OnReceived		= function(t)
		if t.Language then
			...
			t.Text = string.format("[911] %s", t.Text)
		else
			t.Text = string.format("[911] %s: %s", t.Name, t.Text)
		end
