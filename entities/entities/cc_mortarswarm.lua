...
if SERVER then
	...
	function ENT:OnHit(data)
		...
		GAMEMODE:SoundRange(pos, 4000, "tekka/weapons/weapon_mortar_far.wav")
		GAMEMODE:SoundRange(pos, 2000, "tekka/weapons/weapon_mortar_mid.wav")		
		GAMEMODE:SoundRange(pos, 500, "tekka/weapons/weapon_mortar.wav")
	end
end