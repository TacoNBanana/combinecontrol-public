...
SWEP.PrintName 				= "Skynet Plasma Blaster"
...
SWEP.ViewModel 				= Model("models/tnb/trpweapons/c_skynet_shotgun.mdl")
SWEP.WorldModel 			= Model("models/tnb/trpweapons/w_skynet_shotgun.mdl")
