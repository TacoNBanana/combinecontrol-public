...
SWEP.PrintName 				= "Techcom 50-Watt Phased Plasma Rifle"
...
SWEP.ViewModel 				= Model("models/tnb/trpweapons/c_tc_50watt.mdl")
SWEP.WorldModel 			= Model("models/tnb/trpweapons/w_tc_50watt.mdl")
